...
void printTemplateParameters(llvm::raw_ostream &out,
                             clang::PrintingPolicy const &policy,
                             const clang::TemplateParameterList *params);
void printTemplateParameter(llvm::raw_ostream &out,
                            clang::PrintingPolicy const &policy,
                            clang::NamedDecl const *param);

void printTemplateArguments(llvm::raw_ostream &out,
                            const clang::PrintingPolicy &policy,
                            clang::TemplateArgumentList const *args,
                            bool qualifyNames);
// Adapted from tools\clang\lib\AST\TemplateBase.cpp TemplateArgument::print
void printTemplateArgument(llvm::raw_ostream &out,
                           const clang::PrintingPolicy &policy,
